...
public class Vector extends Matrix {
	...
	public Vector add(Vector v) {
		if (v == null) {
			...
			if (getRows() > v.getRows()) {
				// exception: add what you can, leave the rest
			} else {
				throw new MatrixDimensionException(
						"Vector dimension exception: vector dimensions do not agree: "
								+ getRows() + " and " + v.getRows());
			}
		}
	...
	public static final Vector multiply(Matrix a, Vector b) {
		...
		if (a.getColumns() != b.getRows())
			throw new MatrixDimensionException(
					"Matrix dimension exception: matrix dimensions do not agree: "
	...
	public void values(double[] buff) {
		double[] arr = getColumn(0);
