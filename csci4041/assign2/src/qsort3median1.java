...
public class qsort3median1 implements SortingAlgorithm {

   public static void main(String[] args) {
      // pass the the hard work off to a separate function
      Utils.runSort("qsort3median1", args, new qsort3median1());
   }
   ...
   private PivotSelection     selector    = new MedThreeRandomPivot();
