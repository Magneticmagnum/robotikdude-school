...
int main(int argc, char* argv[])
{
  ...
  // Create instance of Logger and initialize with
  // name of log file.  Must be done after scheduler
  // has been created so that the Scheduler object
  // can be passed to the Logger object.
  Logger logger = Logger(&scheduler, logFile);
  logger.print("About to begin simulation with one refrigerator"
    " and duration of 90 ticks.");
  ...
  logger.print("Simulation complete");
